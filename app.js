...
async function start() {
    ...
    await page.waitForSelector('input#usernameInput')
    ...
    // Random email.
    await page.type('input#usernameInput', fullName);
    ...
    await page.type('input#firstNameInput', randomFirstName);
    await page.type('input#lastNameInput', randomLastName);
    await page.keyboard.press('Enter');
